                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                   @auth {{ Auth::user()->name }} - @endauth Web Developer
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @foreach(auth()->user()->role->modules as $module)
                    @if(count($module->permissions->where('menu_display',1)) > 0  )
                        {{--@php($module->permissions->where('menu_display',1)->toArray())--}}
{{--                        {{dd($module->permissions->where('menu_display',1)->pluck('id')->toArray())}}--}}
                        {{--@if(count($module_list)>0)--}}
{{--                        @if(in_array(($module->permissions->where('menu_display',1)->pluck('id')->toArray()),$permission_list))--}}
