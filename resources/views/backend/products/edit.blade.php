    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                {!! Form::model($data['product'], ['route' => ['backend.product.update', $data['product']->id],'files'=>true]) !!}
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var sub_category_id = "{{$data['product']->subcategory_id}}";
            var url = "{{URL::route('backend.subcategory.getDataByCategory_id')}}";
//               alert(url);
            $.ajax({
                url:url,
                data:{'category_id':category_id, 'sub_category_id':sub_category_id,'_token': $('meta[name="csrf_token"]').attr('content')},
                method:'post',
